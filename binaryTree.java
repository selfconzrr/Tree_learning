...
class BinaryTree {
	...
	public static void findPathk(BinaryTreeNode root) {
		Stack<BinaryTreeNode> stack = new Stack<BinaryTreeNode>();
	...
	// 16、根据中序+后序遍历结果重构二叉树
	public static BinaryTreeNode buildTree(int postOrder[], int pend,
	...
	// 17、根据前序+中序遍历结果重构二叉树
	public static BinaryTreeNode buildTree2(int[] preOrder, int start,
